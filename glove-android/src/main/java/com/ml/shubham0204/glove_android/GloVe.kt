...
/**
 * A port of [GloVe (Global Vectors for Word Representation)](https://nlp.stanford.edu/projects/glove/) for Android.
 * Internally, it uses a Python script to load 50D GloVe-embeddings from a HDF5 file and maintains an index
 * as a `dict` for faster access.
 *
 * ### Example Usage:
...
class GloVe {
    ...
    companion object {
        ...
        /** A suspend function which loads embeddings from HDF5 files internally, and stores them in a hashmap
         * for faster access. Once, the embeddings are loaded, retrieval of embeddings is nearly O( 1 ).
        ...
        /**
         * Computes the cosine of the angle (also called 'cosine similarity') between the given two embeddings (vectors)
         * The cosine similarity is a number in the range [ -1 , 1 ], where 1 indicates perfect similarity and
         * -1 indicates a complete dissimilarity.
    ...
    /**
     * After execution of [GloVe.loadEmbeddings], an instance of this class is provided
     * in the result callback. The [GloVeEmbeddings.getEmbedding] method should be used to retrieve embeddings.
     */
